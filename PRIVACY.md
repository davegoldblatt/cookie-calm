...
The extension has no analytics, telemetry, advertising service, account system, remote AI, or reporting endpoint. Its rules are bundled with the extension.
...
If you send an email or file a GitHub issue, the maintainer receives the information you choose to provide.

Support information is used to answer your request or investigate the reported problem. GitHub issues are public.

You can request deletion of a support email through the contact address. GitHub controls issue retention and account information on its service.
...
Policy changes appear in this file with a new effective date. The source code and release history are public in the project repository.
